...
5. **Diff** jämför två versioner på mallnivå: fält är atomära markörer, ändrade exempelvärden ger ingen hunk. Granskningsvyn har samma jämförelse som en egen flik, mot förra versionen, medan du fattar besluten.
